...
void players_data_initialize(void) {
    *players_data = game_state_table_new("players", 16, sizeof(Player));
    *teams_data = game_state_table_new("teams", 16, sizeof(Team));
    
    PlayersGlobals *p_globals = game_state_allocate_heap(sizeof(PlayersGlobals));
