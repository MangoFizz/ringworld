...
enum PixelShaderIndex {
    PS_ENVIRONMENT_LIGHTMAP_NORMAL = 0,
    PS_ENVIRONMENT_LIGHTMAP_NO_LIGHTMAP,
    PS_ENVIRONMENT_LIGHTMAP_NO_ILLUMINATION,
    PS_ENVIRONMENT_LIGHTMAP_NO_ILLUMINATION_NO_LIGHTMAP,
    PS_ENVIRONMENT_DIFFUSE_LIGHTS,
    PS_ENVIRONMENT_TEXTURE_NORMAL_BIASED_MULTIPLY_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_NORMAL_BIASED_MULTIPLY_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_NORMAL_BIASED_MULTIPLY_BIASED_ADD,
    PS_ENVIRONMENT_TEXTURE_NORMAL_MULTIPLY_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_NORMAL_MULTIPLY_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_NORMAL_MULTIPLY_BIASED_ADD,
    PS_ENVIRONMENT_TEXTURE_NORMAL_BIASED_ADD_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_NORMAL_BIASED_ADD_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_NORMAL_BIASED_ADD_BIASED_ADD,
    PS_ENVIRONMENT_TEXTURE_BLENDED_BIASED_MULTIPLY_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_BLENDED_BIASED_MULTIPLY_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_BLENDED_BIASED_MULTIPLY_BIASED_ADD,
    PS_ENVIRONMENT_TEXTURE_BLENDED_MULTIPLY_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_BLENDED_MULTIPLY_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_BLENDED_MULTIPLY_BIASED_ADD,
    PS_ENVIRONMENT_TEXTURE_BLENDED_BIASED_ADD_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_BLENDED_BIASED_ADD_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_BLENDED_BIASED_ADD_BIASED_ADD,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_BIASED_MULTIPLY_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_BIASED_MULTIPLY_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_BIASED_MULTIPLY_BIASED_ADD,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_MULTIPLY_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_MULTIPLY_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_MULTIPLY_BIASED_ADD,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_BIASED_ADD_BIASED_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_BIASED_ADD_MULTIPLY,
    PS_ENVIRONMENT_TEXTURE_SPECULAR_MASK_BIASED_ADD_BIASED_ADD,
    PS_ENVIRONMENT_REFLECTION_BUMPED,
    PS_ENVIRONMENT_REFLECTION_FLAT,
    PS_ENVIRONMENT_REFLECTION_FLAT_SPECULAR,
    PS_ENVIRONMENT_REFLECTION_RADIOSITY,
    PS_ENVIRONMENT_REFLECTION_LIGHTMAP_MASK,
    PS_ENVIRONMENT_REFLECTION_MIRROR_BUMPED,
    PS_ENVIRONMENT_REFLECTION_MIRROR_FLAT,
    PS_ENVIRONMENT_REFLECTION_MIRROR_FLAT_SPECULAR,
    PS_ENVIRONMENT_SPECULAR_LIGHT_FLAT,
    PS_ENVIRONMENT_SPECULAR_LIGHT_BUMPED,
    PS_ENVIRONMENT_SPECULAR_LIGHTMAP_FLAT,
    PS_ENVIRONMENT_SPECULAR_LIGHTMAP_BUMPED,
    PS_TRANSPARENT_PLASMA,
    PS_SHADOW_CONVOLVE,
    PS_ENVIRONMENT_SHADOW,
    PS_WIDGET_SPRITE,
    PS_SCREEN_NORMAL,
    PS_SCREEN_MULTITEXTURE_ADD_ADD,
    PS_SCREEN_MULTITEXTURE_ADD_DOT,
    PS_SCREEN_MULTITEXTURE_ADD_MULTIPLY,
    PS_SCREEN_MULTITEXTURE_ADD_MULTIPLY2X,
    PS_SCREEN_MULTITEXTURE_ADD_SUBTRACT,
    PS_SCREEN_MULTITEXTURE_DOT_ADD,
    PS_SCREEN_MULTITEXTURE_DOT_DOT,
    PS_SCREEN_MULTITEXTURE_DOT_MULTIPLY,
    PS_SCREEN_MULTITEXTURE_DOT_MULTIPLY2X,
    PS_SCREEN_MULTITEXTURE_DOT_SUBTRACT,
    PS_SCREEN_MULTITEXTURE_MULTIPLY_ADD,
    PS_SCREEN_MULTITEXTURE_MULTIPLY_DOT,
    PS_SCREEN_MULTITEXTURE_MULTIPLY_MULTIPLY,
    PS_SCREEN_MULTITEXTURE_MULTIPLY_MULTIPLY2X,
    PS_SCREEN_MULTITEXTURE_MULTIPLY_SUBTRACT,
    PS_SCREEN_MULTITEXTURE_MULTIPLY2X_ADD,
    PS_SCREEN_MULTITEXTURE_MULTIPLY2X_DOT,
    PS_SCREEN_MULTITEXTURE_MULTIPLY2X_MULTIPLY,
    PS_SCREEN_MULTITEXTURE_MULTIPLY2X_MULTIPLY2X,
    PS_SCREEN_MULTITEXTURE_MULTIPLY2X_SUBTRACT,
    PS_SCREEN_MULTITEXTURE_SUBTRACT_ADD,
    PS_SCREEN_MULTITEXTURE_SUBTRACT_DOT,
    PS_SCREEN_MULTITEXTURE_SUBTRACT_MULTIPLY,
    PS_SCREEN_MULTITEXTURE_SUBTRACT_MULTIPLY2X,
    PS_SCREEN_MULTITEXTURE_SUBTRACT_SUBTRACT,
    PS_SCREEN_METER,
    PS_SUN_GLOW_CONVOLVE,
    PS_SUN_GLOW_DRAW,
    PS_EFFECT_MULTITEXTURE_NONLINEAR_TINT,
    PS_EFFECT_MULTITEXTURE_NONLINEAR_TINT_ADD,
    PS_EFFECT_MULTITEXTURE_NONLINEAR_TINT_ALPHA_BLEND,
    PS_EFFECT_MULTITEXTURE_NONLINEAR_TINT_DOUBLE_MULTIPLY,
    PS_EFFECT_MULTITEXTURE_NONLINEAR_TINT_MULTIPLY,
    PS_EFFECT_MULTITEXTURE_NONLINEAR_TINT_MULTIPLY_ADD,
    PS_EFFECT_MULTITEXTURE_NORMAL_TINT,
    PS_EFFECT_MULTITEXTURE_NORMAL_TINT_ADD,
    PS_EFFECT_MULTITEXTURE_NORMAL_TINT_ALPHA_BLEND,
    PS_EFFECT_MULTITEXTURE_NORMAL_TINT_DOUBLE_MULTIPLY,
    PS_EFFECT_MULTITEXTURE_NORMAL_TINT_MULTIPLY,
    PS_EFFECT_MULTITEXTURE_NORMAL_TINT_MULTIPLY_ADD,
    PS_EFFECT_NONLINEAR_TINT,
    PS_EFFECT_NONLINEAR_TINT_ADD,
    PS_EFFECT_NONLINEAR_TINT_ALPHA_BLEND,
    PS_EFFECT_NONLINEAR_TINT_DOUBLE_MULTIPLY,
    PS_EFFECT_NONLINEAR_TINT_MULTIPLY,
    PS_EFFECT_NONLINEAR_TINT_MULTIPLY_ADD,
    PS_EFFECT_NORMAL_TINT,
    PS_EFFECT_NORMAL_TINT_ADD,
    PS_EFFECT_NORMAL_TINT_ALPHA_BLEND,
    PS_EFFECT_NORMAL_TINT_DOUBLE_MULTIPLY,
    PS_EFFECT_NORMAL_TINT_MULTIPLY,
    PS_EFFECT_NORMAL_TINT_MULTIPLY_ADD,
    PS_TRANSPARENT_WATER_OPACITY,
    PS_TRANSPARENT_WATER_REFLECTION,
    PS_TRANSPARENT_WATER_BUMPMAP_CONVOLUTION,
    PS_ACTIVE_CAMOUFLAGE_DRAW,
    PS_TRANSPARENT_GLASS_REFLECTION_BUMPED,
    PS_TRANSPARENT_GLASS_REFLECTION_FLAT,
    PS_TRANSPARENT_GLASS_REFLECTION_MIRROR,
    PS_TRANSPARENT_GLASS_DIFFUSE,
    PS_TRANSPARENT_CHICAGO,
    PS_TRANSPARENT_METER,
    PS_ENVIRONMENT_FOG,
    PS_SCREEN_EFFECT,
    PS_MODEL_ENVIRONMENT,
    PS_MODEL_MASK_SELF_ILLUMINATION,
    PS_MODEL_MASK_CHANGE_COLOR,
    PS_MODEL_MASK_MULTIPURPOSE,
    PS_MODEL_MASK_REFLECTION,
    PS_MODEL_MASK_NONE,
    PS_TRANSPARENT_GENERIC,
    PIXEL_SHADER_FUNCTIONS_MAX
};
...
_Static_assert(sizeof(PixelShader) == 0x10);
...
/**
 * Get the pixel shader for the given index.
 * @param index The index of the pixel shader.
 * @return The pixel shader.
 */
IDirect3DPixelShader9 *rasterizer_dx9_get_pixel_shader(uint16_t ps_index);
